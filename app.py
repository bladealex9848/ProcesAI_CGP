...
APP_IDENTITY = {
    ...
    "version": "1.0.0",
    "icon": "📘",
    "tagline": "Especialista en Derecho Procesal Colombiano",
    "full_title": "¡Bienvenido a ProcesAI CGP! 📘",
    
    # Información del desarrollador
    "developer": "Alexander Oviedo Fadul",
    "github_url": "https://github.com/bladealex9848",
    "website_url": "https://alexanderoviedofadul.dev/",
    "docs_url": "https://github.com/bladealex9848/ProcesAI_CGP/blob/main/README.md",
    ...
    "repository_url": "https://github.com/bladealex9848/ProcesAI_CGP",
    
    # Descripción de la aplicación - formas corta y larga
    "short_description": "Tu asistente especializado en el Código General del Proceso y la Teoría General del Proceso en Colombia.",
    "long_description": """
    ### 📘 ¡Hola! Soy ProcesAI CGP, tu asistente en Derecho Procesal Colombiano

    Estoy aquí para asistirte en comprender y navegar por los fundamentos esenciales del derecho procesal colombiano, con enfoque en el Código General del Proceso.

    #### ¿Qué puedo hacer por ti hoy? 🤔

    * Responder preguntas relacionadas con el Código General del Proceso (Ley 1564 de 2012)
    * Proporcionarte acceso a artículos o secciones específicas del CGP
    * Explicarte conceptos y principios fundamentales del derecho procesal colombiano
    * Orientarte sobre procedimientos, recursos y términos procesales
    * Aclarar dudas sobre competencia, jurisdicción y otros aspectos procesales

    **¡No dudes en consultarme cualquier inquietud sobre derecho procesal colombiano!**

    *Recuerda: Proporciono información general basada en mi conocimiento del Código General del Proceso y la Teoría General del Proceso. Para asesoría legal específica para tu caso, consulta a un abogado calificado.*
    """,
    
    # User instructions
    "usage_instructions": """
    1. **Consultas generales**: Escribe tu pregunta en el chat para recibir información sobre el Código General del Proceso y la Teoría General del Proceso.

    2. **Búsqueda de artículos**: Puedes preguntar sobre artículos específicos del CGP indicando su número o tema.

    3. **Procedimientos judiciales**: Consulta información sobre trámites, recursos y términos en procesos civiles, comerciales y de familia.

    4. **Conceptos procesales**: Pregunta sobre principios, instituciones y figuras del derecho procesal colombiano.

    5. **Referencias normativas**: Solicita información sobre jurisprudencia relevante relacionada con el CGP.
    """,
    ...
    - Extraer texto de documentos legales relacionados con derecho procesal
    - Analizar el contenido de documentos a la luz del Código General del Proceso
    - Identificar información relevante para casos procesales
    - Facilitar el análisis de documentos como demandas, recursos o autos judiciales
    ...
    **Nota sobre privacidad**: Los documentos se procesan localmente y no se almacenan permanentemente.
    ...
    "chat_placeholder": "¿Cómo puedo ayudarte con el Código General del Proceso y la Teoría General del Proceso hoy?",
    "file_upload_default_message": "He cargado el documento '{files}' para análisis. Por favor, analiza su contenido desde la perspectiva del derecho procesal colombiano.",
    "badges": """
    ...
    "welcome_message": """
    ### 📘 ¡Bienvenido a ProcesAI CGP!

    Soy tu asistente especializado en el Código General del Proceso y la Teoría General del Proceso de Colombia. Estoy aquí para ayudarte a comprender estos fundamentos esenciales del derecho procesal colombiano.

    * Puedo responder preguntas sobre artículos específicos del CGP
    * Explicarte conceptos y principios fundamentales
    * Orientarte sobre procedimientos y términos
    * Aclarar dudas sobre recursos y medios de impugnación
    * Proporcionarte información sobre competencia y jurisdicción
    ...
    **¿En qué puedo ayudarte hoy?**
    ...
    "menu_items": {
        ...
        "Report a bug": None,
        "About": "ProcesAI CGP: Especialista en el Código General del Proceso y la Teoría General del Proceso de Colombia",
    },
    ...
    "document_prefix": "procesai",
    "conversation_export_name": "procesai_conversacion",
}
