...
st.set_page_config(
    ...
    page_icon="📘",   # Ícono que representa la justicia y el derecho
...
st.write("""
        [![ver código fuente](https://img.shields.io/badge/Repositorio%20GitHub-gris?logo=github)](https://github.com/bladealex9848/ProcesAI_CGP)
